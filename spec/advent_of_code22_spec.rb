...
RSpec.describe AdventOfCode22 do
  ...
  describe "Day3" do
    let (:input_dir) { data_dir + "day3" }
    let (:example) { IO.read(input_dir + "example") }
    let (:input) { IO.read(input_dir + "test") }

    it "follows the part 1 example" do
      expect(AdventOfCode22::Day3.part_1 example).to eq(157)
    end

    it "solves part 1" do
      expect(AdventOfCode22::Day3.part_1 input).to eq(8185)
    end

    it "follows the part 2 example" do
      expect(AdventOfCode22::Day3.part_2 example).to eq(70)
    end

    it "solves part 2" do
      expect(AdventOfCode22::Day3.part_2 input).to eq(2817)
    end
  end
end
